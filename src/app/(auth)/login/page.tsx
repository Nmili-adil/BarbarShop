  ...
  return (
    <div className="w-full max-w-md">
      <div className="bg-white/5 border border-white/10 backdrop-blur rounded-3xl p-8 shadow-2xl">
        ...
        <p className="text-gray-400 text-sm mb-8">Sign in to your BarberBook account</p>
        ...
        <Button
          variant="outline"
          size="lg"
          className="w-full border-white/10 text-gray-300 hover:text-white hover:bg-white/5 bg-transparent"
